...
if(NOT DEFINED OCE_DIR)
  ...
  elseif(WIN32)
    set(OCE_DIR "C:/OpenCASCADE-7.7.0-vc14-64/opencascade-7.7.0/cmake/")
  endif()
endif()
    ...
    if(WIN32)
      ...
      FIND_PATH(OCC_INCLUDE_DIR Standard_Version.hxx
        ...
        FIND_PATH(OCC_INCLUDE_DIR Standard_Version.hxx
          $ENV{CASROOT}/inc)
        FIND_LIBRARY(OCC_LIBRARY TKernel
          $ENV{CASROOT}/win64/vc14/lib)
        message(INFO " OCC_LIBRARY=${OCC_LIBRARY}")
        message(INFO " OCC_INCLUDE_DIR=${OCC_INCLUDE_DIR}")
